...
class ConvolutionParameter : public ::google::protobuf::Message {
 public:
  ...
  bool has_sparse_ratio() const;
  void clear_sparse_ratio();
  static const int kSparseRatioFieldNumber = 19;
  float sparse_ratio() const;
  void set_sparse_ratio(float value);
  ...
  ::google::protobuf::int32 class_num() const;
  void set_class_num(::google::protobuf::int32 value);

  // optional bool quantize_term = 21 [default = false];
  bool has_quantize_term() const;
  void clear_quantize_term();
  static const int kQuantizeTermFieldNumber = 21;
  bool quantize_term() const;
  void set_quantize_term(bool value);
